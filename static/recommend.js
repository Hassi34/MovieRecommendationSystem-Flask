$(function() {
  ...
  $('.movie-button').on('click',function(){
    var my_api_key = '404921924373365e328ce7dd5e96e9b7';
    var title = $('.movie').val();
    if (title=="") {
...
// passing all the details to python's flask q  for displaying and scraping the movie reviews using imdb id
